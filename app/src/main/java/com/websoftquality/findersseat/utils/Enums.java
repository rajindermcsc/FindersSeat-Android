...
public class Enums {
    public static final String MY_PHONE_NUMBER = "com.websoftquality.findersseat.views.signup.PhoneNumberFragment";
    public static final String ONE_TIME_PWD = "com.websoftquality.findersseat.views.signup.OneTimePwdFragment";
    public static final String GENDER = "com.websoftquality.findersseat.views.signup.GenderFragment";
    public static final String FIRST_NAME = "com.websoftquality.findersseat.views.signup.FirstNameFragment";
    public static final String LAST_NAME = "com.websoftquality.findersseat.views.signup.LastNameFragment";
    public static final String PASSWORD = "com.websoftquality.findersseat.views.signup.PasswordFragment";
    public static final String BIRTHDAY = "com.websoftquality.findersseat.views.signup.BirthdayFragment";
    public static final String EMAIL = "com.websoftquality.findersseat.views.signup.EmailFragment";
    public static final String PROFILE_PICK = "com.websoftquality.findersseat.views.signup.ProfilePickFragment";
