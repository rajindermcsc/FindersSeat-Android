...
-keep public class com.websoftquality.findersseat.datamodels.** {*;}
-keep class com.websoftquality.findersseat.views.main.LoginActivity
-keep class com.websoftquality.findersseat.utils.** {*;}
-keepclasseswithmembernames class com.websoftquality.findersseat.utils.** {*;}
